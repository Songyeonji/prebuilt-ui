...
export default function HomePage() {
  return (
    <div className="mx-auto flex max-w-content flex-col gap-10">
      <header>
        <h1 className="text-4xl font-extrabold tracking-tight">Prebuilt UI</h1>
      ...
      <section>
        <h2 className="mb-3 text-xl font-bold">사용법</h2>
        <CodeBlock
          code={`
...
export default function Page() {
  return <Button variant="primary">저장하기</Button>;
      ...
      <section>
        <h2 className="mb-3 text-xl font-bold">컴포넌트 ({componentDocs.length})</h2>
