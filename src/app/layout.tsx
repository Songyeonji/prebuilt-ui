    ...
    <html lang="ko">
      <body className="bg-surface font-sans text-fg antialiased">
        <div className="flex min-h-screen flex-col md:flex-row">
          <aside className="border-b border-border bg-surface-subtle p-4 md:sticky md:top-0 md:h-screen md:w-60 md:shrink-0 md:overflow-y-auto md:border-r md:border-b-0 md:px-4 md:py-6">
            <Link href="/" className="mb-3 flex items-center gap-2 px-2 text-base font-extrabold md:mb-0">
              <span className="grid size-7 place-items-center rounded-md bg-primary text-sm text-fg-inverse">P</span>
              Prebuilt UI
            </Link>
